...
A `dbm` generator for use with the Sails command-line interface.


## Installation

```sh
$ npm install sails-generate-dbm --save
```
...
{
  "modules": {
    "dbm": "sails-generate-dbm"
  }
}
```

> Note that instead of `"sails-generate-dbm"`, you can also choose to provide the path to the generator locally (e.g. "./generators/dbm").
...
## Bugs &nbsp; [![NPM version](https://badge.fury.io/js/sails-generate-dbm.svg)](http://npmjs.com/package/sails-generate-dbm)
...
[![NPM](https://nodei.co/npm/sails-generate-dbm.png?downloads=true)](http://npmjs.com/package/sails-generate-dbm)



## License

This dbm generator is available under the **MIT license**.
